...
- `lowlim`: The lower limit of production allowed in that layer in \mu mol m^-3^ s^-1^ 
- `highlim`: The upper limit of production allowed in that layer in \mu mol m^-3^ s^-1^ 
