...
#'
#' @description This function helps overriding the Date-based subsetting of offset_subsetting().
#' It modifies an existing corr_map by editing the section of a list of SAMPLE_NO. Check the section numbering of corr_map first.
#' If a new section is manually introduced this way, a mode will have to be added manually.
#'
#'
#' @param corr_map (dataframe) The corr_map dataframe created by offset_subsetting
#' @param SAMPLE_NO (character) A vector of the SAMPLE_NO to change section
#' @param section (vector, numeric) A vector in the same order as SAMPLE_No specifying the target section.
#'
#' @return corr_map (dataframe) The corr_map dataframe used in the offset_correction function with overridden SAMPLE_NO.
#'
